...
export interface ApiCategoriaCategoria extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    categoriaFoto: Schema.Attribute.Media<
...
export interface ApiProductoProducto extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    esDestacado: Schema.Attribute.Boolean;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
    ...
    productoPrecio: Schema.Attribute.Integer;
    productoStock: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<true>;
    productoTipo: Schema.Attribute.Enumeration<
      [
        'Anillos',
        'Abridores',
        'Argollas',
